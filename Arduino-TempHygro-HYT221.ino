...
void loop()
{
  ...
  {                   
    ...
    lcd.print(String(temperature, 7));                      //Print Temperature reading of HYT211 as String with 7 decimal digits. Only 6 are delivered. 7th is always 0.
    ...
    lcd.print(String(humidity, 7));                         //Print Humidity reading of HYT211 as String with 7 decimal digits. Only 6 are delivered. 7th is always 0.
